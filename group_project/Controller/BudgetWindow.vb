...
Public Class BudgetWindow
    ...
    'This property is the budget object that contains the final user inputs
    ...
    'Handles exception when there is a problem in the middle of casting process, if it happens, returns -1
    ...
    Private Sub displayBudgetInterface()
        ...
        Dim yLoc As Integer = 0 'location of y point
        ...
        For index = 0 To m_arr_size - 1
            ...
            labels.Location = New Point(xSpacing, yLoc)
            d_displayPanel.Controls.Add(labels) 'Add to this window
            ...
            m_textboxes(index).Location = New Point(xSpacing + 200, yLoc)
            AddHandler m_textboxes(index).TextChanged, AddressOf updateUnallocBudget 'Include textchanged event handler
            d_displayPanel.Controls.Add(m_textboxes(index)) 'Add to this window

            'Setup prev label attributes
            Dim prev As New Label
            prev.Text = (m_prevBudgets(index)).ToString
            prev.AutoSize = True
            prev.Location = New Point(xSpacing + 300, yLoc)
            d_displayPanel.Controls.Add(prev) 'Add to this window
    ...
    Private Sub d_commitButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles d_commitButton.Click
    ...
    'Handles an exception when there is a problem of casting string into integer. If it happens, returns false
    ...
    Private Sub d_resetButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles d_resetButton.Click
