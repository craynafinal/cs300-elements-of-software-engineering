...
Public Class world
    ...
    Dim food_rates As Double() = {0.01, 0.01, 0.0, 0.0, 0.0}
    Dim income_rates As Double() = {0.0, 0.01, 0.01, 0.01, 0.0}
    Dim population_rates As Double() = {0.03, 0.01, 0.0, -0.012, 0.0}
    Dim environment_rates As Double() = {-0.01, 0.0, -0.02, 0.01, 0.01}

    Dim COEFF As Object() = {food_rates, income_rates, population_rates, environment_rates}
    ...
    Public Function Get_Model_Coefficients() As Object()
        Return COEFF
    End Function
    ...
    Public Sub New(Optional ByVal game As world = Nothing, Optional ByVal difficulty As Integer = 2,
        ...
        If Not IsNothing(game) Then
            ...
            ' If the difficulty is not a valid choice (1,3,5), then automatically
            ' reset difficulty to the default 3.
            If (game.difficulty <> 5 And game.difficulty <> 1) Then
                game.difficulty = 3
            End If
    ...
    Public Sub Change_Multiplier(ByVal multiplier As Integer)
        ...
        advanced_multiplier = multiplier 'This must record
    End Sub
